...
# shutil.move(src_dir + "//plot//plot.jpg", run_dir + "plot.jpg")
shutil.move(src_dir + "//memory//memory0015.p", run_dir + "//memory//memory0015.p")
# shutil.move(src_dir + "//memory//memory0010.p", run_dir + "//memory//memory0010.p")
